...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'l'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-l@main/recipes/<cuisine>/<diet>/<slug>.json
```
